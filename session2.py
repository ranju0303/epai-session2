...
class Something(object):
    ...
    def __repr__(self):
        return 'Custom Representation:::{0}'.format(self.something_new)
class SomethingNew(object):
    ...
    def __repr__(self):
        return 'Custom Representation:::{0}'.format(self.something)
...
#time.sleep(1) # remove this line, this is just to simulate your "slow" code
    ...
    for i in range(10000000):
        if a is b:
            pass
    char_list = set(a)
    for j,i in enumerate(range(10000000)):
        if 'd' in char_list:
            break
